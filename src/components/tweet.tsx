...
const EditFile = styled.div`
  ...
  label {
    ...
    height: 25px;
    font-size: 0;
    background: rgba(0, 0, 0, 0.8) url("/edit.svg") no-repeat center;
...
const DeleteFile = styled.div`
  ...
  height: 25px;
  font-size: 0;
  background: rgba(255, 51, 28, 0.8) url("/remove.svg") no-repeat;
  ...
  return (
    <Wrapper>
      <Column>
        ...
        {edit ? <TextArea defaultValue={tweet} onChange={onChange} /> : <Payload>{tweet}</Payload>}
        {user?.uid === userId ? (
          <>
        ...
        <ColumnFile>
          ...
          <EditFileArea>
            <EditFile>
              ...
              <input type="file" id="tweetFile" accept="image/*" onChange={onEditFile} />
            </EditFile>
